...
client.on('guildMemberAdd', member => {
    client.guilds.get(member.guild.id).channels.get("418834373610307586").send(`Olá ${member}, Obrigado por entrar no Player South - Brasil Leia as regras e tenha uma boa estadia. `, {file: {attachment: canvas.toBuffer(), name: 'welcome.gif'}});
   })
...
client.on("ready", () => {
    ...
    client.user.setGame("pika em " + client.users.size + " Membros");
